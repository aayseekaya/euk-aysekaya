                    ...
                    <div class="m-form m-form--label-align-right m--margin-bottom-30">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                <a href="{{env("APP_URL")}}/admin/infos/{{$result["module_id"]}}/activites/{{$result["id"]}}/add" class="btn btn-primary m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
                                    <span>
                                ...
                                <div class="m-portlet__body" style="padding: 0;">
                                    <ol class="list sortable">
                                        ...
                                        <li id="list_<?php echo $value->id; ?>">
                                            ...
                                            <div class="islem">
                                                        <span><?php echo $value->remaining_quota."/".$value->quota ;?></span>
                                                        <a href="<?php echo env("APP_URL")."/admin/infos/".$result["module_id"]."/activites/".$result["id"]."/edit/".$value->id;?>" class="edit-button m-portlet__nav-link btn m-btn btn-primary m-btn--icon m-btn--icon-only m-btn--pill"><i class="la la-edit"></i></a>
                                                        <a href="<?php echo env("APP_URL")."/admin/infos/".$result["module_id"]."/activites/".$result["id"]."/delete/".$value->id;?>" class="delete-button m-portlet__nav-link btn m-btn btn-danger m-btn--icon m-btn--icon-only m-btn--pill"><i class="la la-trash"></i></a>
                                            </div>
                                        </li>
                                        <?php } ?>
                                    </ol>
